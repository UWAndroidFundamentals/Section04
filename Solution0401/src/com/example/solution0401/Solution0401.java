package com.example.solution0401;
...
public class Solution0401 extends Activity {
    ...
    private void addSecondSubMenu(Menu menu)
    {
    	//Secondary items are shown just like everything else
    	int base=Menu.FIRST + 100;
    	SubMenu sm = menu.addSubMenu(base,base+1,Menu.NONE,"submenu2");
    	MenuItem item1 = sm.add(base,base+2,base+2,"sub2 item1");
    	
    	sm.add(base,base+3,base+3, "sub2 item2");
    	sm.add(base,base+4,base+4, "sub2 item3");
